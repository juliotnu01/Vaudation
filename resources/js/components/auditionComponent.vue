            ...
            <v-layout row wrap>
                ...
                <v-flex xs12 sm12 md12 class="m-3">
                    ...
                    >
                        ...
                        <template
                            v-slot:item.script_attached_audition="{ item }"
                        >
                            <img
                                src="https://img.icons8.com/metro/26/000000/pdf-2.png"
                            />
                            <a :href="item.script_attached_audition"
                                >PDF attachmend</a
                            >
                        </template>
                    </v-data-table>
            ...
            <v-layout row wrap>
                <v-flex xs12 sm12 md12>
                    <v-btn
                        ...
                        dark
                        color="warning"
                        @click.prevent="dialog_scene = true"
                    >
                        <v-icon dark>mdi-plus</v-icon>
                    </v-btn>
                </v-flex>
            ...
            <v-card>
                ...
                <v-container>
                    <v-layout row wrap class="m-1">
                        <v-flex xs12 sm12 md12>
                            <v-text-field
                                label="Title Audition"
                                v-model="var_title_audition"
                            ></v-text-field>
                        </v-flex>
                        <v-flex xs12 sm12 md12>
                            <v-text-field
                                label="Description Audition"
                                v-model="var_description_audition"
                            ></v-text-field>
                        </v-flex>
                        <v-flex xs12 sm12 md12 class="m-3">
                            <!-- upload button -->
                        ...
                        <v-flex
                            ...
                            sm12
                            md12
                            class="m-3 elevation-2"
                            v-if="imgF === '' ? false : true"
                        >
                        ...
                        <v-flex xs12 sm12 md12 class="m-3">
                            <v-textarea
                                outlined
                                name="input-7-4"
                                label="Script audition text"
                                v-model="var_script_text_audition"
                            ></v-textarea>
                        </v-flex>
                        <v-flex xs12 sm12 md12 class="m-3 ">
                ...
                <v-container>
                    <v-layout row wrap class="m-1">
                        ...
                        <v-flex xs12 sm12 md12>
                            <v-text-field
                                label="Act Scene"
                                v-model="var_act_scene"
                            ></v-text-field>
                        </v-flex>
                        <v-flex xs12 sm12 md12>
                            <v-text-field
                                label="Number Scene"
                                v-model="var_number_scene"
                            ></v-text-field>
                        </v-flex>
                        <v-flex xs12 sm12 md12>
                            <v-text-field
                                label="Scene Direction"
                                v-model="var_scene_direction"
                            ></v-text-field>
                        </v-flex>
                        <v-flex xs12 sm12 md12>
                            <v-text-field
                                label="Character Scene"
                                v-model="var_character_scene"
                            ></v-text-field>
                        </v-flex>
                        <v-flex xs12 sm12 md12 class="m-3">
                            <v-textarea
                                outlined
                                name="input-7-4"
                                label="Description Character Scene"
                                v-model="var_description_character_scene"
                            ></v-textarea>
                        </v-flex>
                        <v-flex xs12 sm12 md12 class="m-3">
                            <v-textarea
                                outlined
                                name="input-7-4"
                                label="Dialogue Character Scene"
                                v-model="var_dialogue_character_scene"
                            ></v-textarea>
                        </v-flex>
                    </v-layout>
                </v-container>
